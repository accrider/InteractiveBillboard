...
<?php getSidebar() ?>
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Edit Tile</a></li>
			</ul>

			<div class="row-fluid">
			<!-- CONTENT -->
<?php
$query = "select * from tiles where tile_id = ".$_GET['id'];
$result = $mysqli->query($query);
if ($result) {
	$row = $result->fetch_array();
	//print("test");
	//print_r($row['tile_contents']);
					...
					<div class="box-content">
						<form class="from-horizontal" id="tile_form">
							<div id="tile_name" class="control-group">
								...
								<input name="name" id="tileName" size="32" type="text" value="<?= $row['tile_name']?>" />
							</div>
							...
							<div class="control-group">
							  <label class="control-label">Tile HTML</label>
								<textarea id="code" name="code"><?=$row['tile_contents']?></textarea>
							</div>
